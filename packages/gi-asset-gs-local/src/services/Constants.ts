...
export const HTTP_SERVICE_URL = "http://dev.alipay.net:7001";

export const DefaultGraphScopeNodeFilePath =
  "/home/graphscope/dongze.ldz/alibaba/gstest/property/p2p-31_property_v_0";
export const DefaultGraphScopeEdgeFilePath =
  "/home/graphscope/dongze.ldz/alibaba/gstest/property/p2p-31_property_e_0";
...
const ChinaVisDataPathMapping = {
  ...
  edgeFiles: {
    ...
    r_cert_chain_Cert_Cert: {
      ...
      targetNodeType: "Cert",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_cert_chain_Cert_Cert.csv"
    },
    r_cert_Domain_Cert: {
      edgeType: "r_cert",
      ...
      targetNodeType: "Cert",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_cert_Domain_Cert.csv"
    },
    // 第二列
    r_cidr_IP_IP_CIDR: {
      edgeType: "r_cidr",
      ...
      targetNodeType: "IP_C",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_cidr_IP_IP_CIDR.csv"
    },
    r_cname_Domain_Domain: {
      ...
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_cname_Domain_Domain.csv"
    },
    r_dns_a_Domain_IP: {
      edgeType: "r_dns_a",
      sourceNodeType: "Domain",
      targetNodeType: "IP",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_dns_a_Domain_IP.csv"
    },
    r_request_jump_Domain_Domain: {
      ...
      targetNodeType: "Domain",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_request_jump_Domain_Domain.csv"
    },
    // 第三列
    r_subdomain_Domain_Domain: {
      ...
      targetNodeType: "Domain",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_subdomain_Domain_Domain.csv"
    },
    r_whois_email_Domain_Whois_Email: {
      ...
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_whois_email_Domain_Whois_Email.csv"
    },
    r_whois_name_Domain_Domain: {
      ...
      targetNodeType: "Domain",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_whois_name_Domain_Domain.csv"
    },
    r_whois_name_Domain_Whois_Name: {
      ...
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_whois_name_Domain_Whois_Name.csv"
    },
    // 第四列
    r_whois_name_Domain_Whois_Phone: {
      ...
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_whois_name_Domain_Whois_Phone.csv"
    },
    r_whois_name_Whois_Phone_Domain: {
      ...
      targetNodeType: "Domain",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_whois_name_Whois_Phone_Domain.csv"
    },
    r_whois_phone_Domain_Whois_Phone: {
      ...
      targetNodeType: "Whois_Phone",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_whois_phone_Domain_Whois_Phone.csv"
    },
    r_whois_phone_Whois_Name_Domain: {
      ...
      targetNodeType: "Domain",
      filePath:
        "/home/graphscope/.gshttpserver/dataset/vis/r_whois_phone_Whois_Name_Domain.csv"
    }
  }
};
...
export const LoadChinaVisDataSource = {
  ...
  edges: [
    ...
    },
    {
      ...
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cert_Domain_Cert.sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cert_Domain_Cert.targetNodeType,
      srcField: SRC_FIELD,
      dstField: DST_FIELD,
      config: {
        header_row: true,
    ...
    },
    {
      ...
      location:
        ChinaVisDataPathMapping.edgeFiles.r_cert_chain_Cert_Cert.filePath,
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cert_chain_Cert_Cert.sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cert_chain_Cert_Cert.targetNodeType,
      srcField: SRC_FIELD,
      dstField: DST_FIELD,
      config: {
        header_row: true,
    ...
    },
    {
      ...
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cidr_IP_IP_CIDR.sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cidr_IP_IP_CIDR.targetNodeType,
      srcField: SRC_FIELD,
      dstField: DST_FIELD,
      config: {
        header_row: true,
    ...
    },
    {
      ...
      location:
        ChinaVisDataPathMapping.edgeFiles.r_cname_Domain_Domain.filePath,
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cname_Domain_Domain.sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_cname_Domain_Domain.targetNodeType,
      srcField: SRC_FIELD,
      dstField: DST_FIELD,
      config: {
        header_row: true,
    ...
    },
    {
      ...
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_dns_a_Domain_IP.sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_dns_a_Domain_IP.targetNodeType,
      srcField: SRC_FIELD,
      dstField: DST_FIELD,
      config: {
        header_row: true,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_request_jump_Domain_Domain.edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_request_jump_Domain_Domain.filePath,
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_request_jump_Domain_Domain
          .sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_request_jump_Domain_Domain
          .targetNodeType,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_subdomain_Domain_Domain.edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_subdomain_Domain_Domain.filePath,
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_subdomain_Domain_Domain
          .sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_subdomain_Domain_Domain
          .targetNodeType,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_whois_email_Domain_Whois_Email
          .edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_whois_email_Domain_Whois_Email
          .filePath,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Domain.edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Domain.filePath,
      srcLabel:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Domain
          .sourceNodeType,
      dstLabel:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Domain
          .targetNodeType,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Whois_Name
          .edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Whois_Name
          .filePath,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Whois_Phone
          .edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Domain_Whois_Phone
          .filePath,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Whois_Phone_Domain
          .edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_whois_name_Whois_Phone_Domain
          .filePath,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_whois_phone_Domain_Whois_Phone
          .edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_whois_phone_Domain_Whois_Phone
          .filePath,
    ...
    {
      label:
        ChinaVisDataPathMapping.edgeFiles.r_whois_phone_Whois_Name_Domain
          .edgeType,
      location:
        ChinaVisDataPathMapping.edgeFiles.r_whois_phone_Whois_Name_Domain
          .filePath,
