export const roles = [
  {
    ...
    slogan: (
      <span>
        图分析应用<span style={{ color: 'var(--primary-color)' }}>研发</span>工具
      </span>
    ),
    desc:
      '对开发者而言，GraphInsight 是基于 AntV 开源技术栈 G6 / Graphin 之上的低代码搭建工具。开发者可根据业务需求，在线进行产品模块的组合搭建，生成的图分析画布还可一键导出配置代码，生成SDK，集成到业务系统中，大大降 低初始研发门槛 与 后续维护成本。',
  },
  {
    id: 'analyst',
    title: '分析师',
    ...
    slogan: (
      <span>
        图可视分析<span style={{ color: 'var(--primary-color)' }}>洞察</span>工具
      </span>
    ),
    desc:
      '对分析师而言，GraphInsight 是一款能够将关系数据，在线可视化展示，并且持续分析洞察的工具。与传统的BI工具相比，GraphInsight 不仅能够直接给出数据的洞察结果，也能够辅助用户完成数据动态分析的过程，以及提供场景化分析能力。',
  },
];
...
export const developer = [
  {
    ...
    description:
      '数据的多源异构，业务逻辑的复杂性加剧，越来越多的企业面临深度关联分析需求 ，也会涌现相当多的创新产品，使用图的思维来分析解决问题。对于开发者而言，如何快速实现产品功能，满足业务POC验证，就变成一个非常头痛的问题。GraphInsight 提供了丰富的图分析分析资产，用户无需代码开发，即可在平台上搭建出一个图分析画布',
    image: 'https://gw.alipayobjects.com/mdn/rms_3e4ddf/afts/img/A*jvKiTZnT5uUAAAAAAAAAAAAAARQnAQ',
  },
  {
    title: '零成本上手开发，专注你所关心的',
    description:
      'GraphInsight 是基于 AntV 开源技术栈 G6 / Graphin 之上的产品级技术方案，提供了高性能的 SDK 以及组件资产的研发规范，对于开发者而言，这里没有d3/g6/cytoscape 等技术方案选型与高昂的学习成本，复杂的技术逻辑与交互方案全部内置，且通过上下文 (Context) 轻松获取，零成本上手开发，像写普通的业务组件一样顺手',
    image: 'https://gw.alipayobjects.com/mdn/rms_3e4ddf/afts/img/A*IUkJQJdxmDIAAAAAAAAAAAAAARQnAQ',
  },
  {
    title: '极速部署上线，一切只为开放而生',
    description:
      '长久以来，图分析应用都面临着开发周期长，维护成本高的问题，面对复杂的业务场景，还时常面临定制开放需求。GraphInsight 设计之初就面向开放制定，不仅提供一键代码导出功能，方便开发者部署，还提供「套娃」开放的能力，无论多么复杂的业务场景，保持开放，永远是 GraphInsight 的产品设计初心！',
