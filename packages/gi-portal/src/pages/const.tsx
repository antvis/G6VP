export const roles = [
  {
    ...
    desc:
      '对开发者而言，GraphInsight 是基于 AntV 开源技术栈 G6 / Graphin 之上的低代码搭建工具。开发者可根据业务需求，在线进行产品模块的组合搭建，生成的图分析画布还可一键导出配置代码，生成 SDK，集成到业务系统中，大大降 低初始研发门槛 与 后续维护成本。',
  },
  {
    id: 'analyst',
    title: '分析师',
    ...
    desc:
      '对分析师而言，GraphInsight 是一款能够将关系数据在线可视化展示，并能持续分析洞察的工具。与传统的 BI 工具相比，GraphInsight 不仅能够直接给出数据的洞察结果，也能够辅助用户完成数据的动态分析，并提供场景化分析能力。',
  },
];
