...
const PatternPane: React.FC<Props> = ({
  id,
  data,
  schemaEdgeMap,
  editPattern,
  ...
  const modifyPatternMenuItems = buildPatternMenuItems.concat(<Menu.Item onClick={downloadPatternData}>
  ...
  return (<div className="kg-pattern-pane-content">
    {data ? <div className="kg-pattern-pane-graph">
