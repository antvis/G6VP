...
export const TEMPALTE_TUGRAPH = getConfigByEngineId('TuGraph');
export const TEMPALTE_GRAPHSCOPE = getConfigByEngineId('GraphScope');
export const TEMPALTE_NEO4J = getConfigByEngineId('Neo4j');
export const TEMPALTE_GEAFLOW = getConfigByEngineId('GeaFlow');
export const TEMPALTE_GI = getConfigByEngineId('GI');
