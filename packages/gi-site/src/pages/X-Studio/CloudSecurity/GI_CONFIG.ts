...
export const GI_SERVICES_OPTIONS = [
  ...
  },
  {
    ...
    content: 'export default (e,t)=>{const{data:n}=e;return new Promise((e=>e(n)))}',
  },
  {
    ...
    content:
      'export default e=>{const{id:t}=e;return fetch("http://dev.alipay.net:7001/graphcompute/properties",{method:"post",headers:{"Content-Type":"application/json;charset=utf-8"},body:JSON.stringify({id:[t],gremlinServer:localStorage.getItem("graphScopeGremlinServer")})}).then((e=>e.json())).then((e=>{const{success:n,data:r}=e;return n?r[t]:e}))}',
  },
  {
    id: 'MOCK/Save',
    mode: 'MOCK',
    name: 'MOCK/Save',
    content:
      'export default (e,t)=>{const n=`${Math.random().toString(36).substr(2)}`,i=window.location.origin+"/#/share/"+n,{localforage:r}=window;return r.setItem(n,{id:n,type:"save",params:JSON.stringify(e)}),new Promise((e=>e({success:!0,data:i})))}',
  },
];
export const GI_PROJECT_CONFIG = {
  nodes: [
    ...
    },
    {
      ...
      props: {
        size: 26,
        color: '#3056E3',
        label: ['僵尸网络家族.id', '僵尸网络家族.legendType'],
        advanced: {
          icon: {
            type: 'font',
            value: '',
  ...
  components: [
    ...
    },
    {
      ...
      name: '操作栏',
      props: {
        GI_CONTAINER: ['FilterPanel', 'NodeImportance', 'Save', 'PathAnalysis'],
        placement: 'LT',
        offset: [0, 0],
        height: '60px',
        width: '100%',
