  ...
  })(
    {
      ...
      4: [
        function (a, b, c) {
          ...
          function j(a) {
            return (
              'string' != typeof a && (console.warn(a + ' used as a key, but it is not a string.'), (a = String(a))), a
            );
          }
          function k() {
                    ...
                    return new va(function (b, c) {
                      ...
                      (d.onerror = function () {
                        ...
                        (d.onblocked = function () {
                          console.warn(
                            'dropInstance blocked for database "' + a.name + '" until all open connections are closed',
                          );
                        }),
